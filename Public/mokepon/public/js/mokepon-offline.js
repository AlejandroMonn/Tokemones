...
function revisarVidas() {
    if (victoriasJugador === victoriasEnemigo) {
        crearMensajeFinal("It was a tie!!!")
...
function iniciarMapa() {
    ...
    mokeponesEnemigos = [
        new Mokepon('Hipodoge', './assets/mokepons_mokepon_hipodoge_attack.png', 5, './assets/hipodoge.png'),
        new Mokepon('Capipepo', './assets/mokepons_mokepon_capipepo_attack.png', 5, './assets/capipepo.png'),
        new Mokepon('Ratigueya', './assets/mokepons_mokepon_ratigueya_attack.png', 5, './assets/ratigueya.png'),
    ]

    mokeponesEnemigos[0].ataques.push(...HIPODOGE_ATAQUES)
    mokeponesEnemigos[1].ataques.push(...CAPIPEPO_ATAQUES)
    mokeponesEnemigos[2].ataques.push(...RATIGUEYA_ATAQUES)

    // Esperar carga de imagen para evitar pantalla azul vacia
